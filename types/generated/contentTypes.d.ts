...
export interface ApiSalleSalle extends Schema.CollectionType {
...
export interface ApiSeanceSeance extends Schema.CollectionType {
  ...
  attributes: {
    Film: Attribute.Relation<
      ...
      'api::film.film'
    >;
    Salle: Attribute.Relation<
      'api::seance.seance',
      'manyToOne',
      'api::salle.salle'
    >;
    DateHeureSeance: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
